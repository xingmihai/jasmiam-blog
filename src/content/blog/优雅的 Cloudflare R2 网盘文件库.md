...
### 🌟 项目简介
:::note
 📌 [![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/xingmihai/FlareDrive-R2-Workers)，因为Cloudflare pages 优选太麻烦，所以有了此项目
:::
