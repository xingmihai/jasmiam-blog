export default {
  ...
  Subtitle: '一起慢慢进步.',
  // 网站描述
  Description: '静谧幻想家的博客 专注于相关技术的实战分享。同时，博客也分享作者的生活、音乐和旅行的热爱。',
  // 网站作者
  Author: '𝑱𝑨𝑺𝑴𝑰𝑨𝑴',
  // 作者头像
...
//https://waline2.jasmiam.top
  ...
  GoogleAds: {
    ...
    // 文章页广告(不填不开启)
    articleAD_Slot: `<ins class="adsbygoogle" style="display:block" data-ad-client="ca-pubxxxxxx" data-ad-slot="xxxxxx" data-ad-format="auto" data-full-width-responsive="true"></ins>`
  },
  // 文章内赞赏码
  Reward: {
    // 支付宝收款码
